...
class EncryptedFieldFactory:
    ...
    def __init__(self) -> None:
        """Initialize the factory without a bound adapter or config."""
    ...
    def create(
        ...
        raise RuntimeError("App not initialized yet. Please call init_app first")
...
class SecretsMigrator:
    ...
    def __init__(self, previous_secret_key: str) -> None:
        """Store the previous secret key used to decrypt existing values."""
